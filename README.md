...
<img align="right" alt="motivation.txt" src="https://github.com/PaulaWiltiner/PaulaWiltiner/blob/main/repeat.gif?raw=true" width="360" height="360" />
...
![AI-DLC](https://img.shields.io/badge/AI--DLC-6E56CF?style=for-the-badge)
...
|---|---|---|
| [**apprendu**](https://github.com/PaulaWiltiner/apprendu) | Nuxt 3 web app | Nuxt · Vue · TypeScript · SCSS |
| [**LetsNote**](https://github.com/PaulaWiltiner/projeto21-autoral-frontend) | Minimalist full-stack notes app — Vue SPA + TypeScript REST API, containerized | Vue · TypeScript · Docker |
| [**ProntuaPet**](https://github.com/PaulaWiltiner/prontuapet) | Pet health-records REST API with validation & data modeling | TypeScript · Node · Express |
